...
Workflow.Data<-WorkflowPathData(EvaluationExperimentSet,ReferenceSet)
...
```{r}
Merged.options<-BuildEvaluationStructure(Workflow.Data,EvaluationTag=c("RNASeqv1","RNASEQv2"))
...
```{r}
Model.quality.object<-WorkflowPathModelQuality(Merged.options)
...
```{r}
Model.Quality<-ModelQualityPairs(Model.quality.object,method="pearson")
...
```{r}
Model.Quality<-ModelQualityPairs(Model.quality.object,method="spearman")
head(as.data.frame(Model.Quality))
```
...
```{r,message=FALSE}
Posterior.dataframe<-EstimatePosteriorProbability(Model.quality.object,Model.Quality)
...
```{r}
Evaluation.table<-WorkflowEvaluationTable(Posterior.dataframe)
Evaluation.table
...
```{r}
WorkflowEvaluationTable(Posterior.dataframe,deltaPlus = 2)
WorkflowEvaluationTable(Posterior.dataframe,Utp=3)
...
ReferenceSet<-RPPADATA
Workflow.Data<-WorkflowPathData(EvaluationExperimentSet,ReferenceSet)
Merged.options<-BuildEvaluationStructure(Workflow.Data,EvaluationTag=c("RNASeqv1","RNASeqv2","PICCOLO"))
Model.quality.object<-WorkflowPathModelQuality(Merged.options)
Model.Quality<-ModelQualityPairs(Model.quality.object,method="pearson")
Posterior.dataframe<-EstimatePosteriorProbability(Model.quality.object,Model.Quality)
Evaluation.table<-WorkflowEvaluationTable(Posterior.dataframe)
...
Workflow.Data<-WorkflowPathData(EvaluationExperimentSet,ReferenceSet)
Merged.options<-BuildEvaluationStructure(Workflow.Data,EvaluationTag=c("AllGeneIDs","TransmembraneGenesOnly","Non-TransmembraneGenes","Low-Complexity","High-Complexity"))
Model.quality.object<-WorkflowPathModelQuality(Merged.options)
Model.Quality<-ModelQualityPairs(Model.quality.object,method="pearson")
Posterior.dataframe<-EstimatePosteriorProbability(Model.quality.object,Model.Quality)
Evaluation.table<-WorkflowEvaluationTable(Posterior.dataframe)
Evaluation.table
Evaluation.tableL2<-WorkflowEvaluationTable(Posterior.dataframe,Lfp = 2)
Evaluation.tableL3<-WorkflowEvaluationTable(Posterior.dataframe,Lfp = 3)
Evaluation.tableL4<-WorkflowEvaluationTable(Posterior.dataframe,Lfp = 4)
Evaluation.tableL5<-WorkflowEvaluationTable(Posterior.dataframe,Lfp = 5)
Evaluation.tableL6<-WorkflowEvaluationTable(Posterior.dataframe,Lfp = 6)
...
Evaluation.tableU2<-WorkflowEvaluationTable(Posterior.dataframe,Utp = 2)
Evaluation.tableU3<-WorkflowEvaluationTable(Posterior.dataframe,Utp = 3)
Evaluation.tableU4<-WorkflowEvaluationTable(Posterior.dataframe,Utp = 4)
Evaluation.tableU5<-WorkflowEvaluationTable(Posterior.dataframe,Utp = 5)
Evaluation.tableU6<-WorkflowEvaluationTable(Posterior.dataframe,Utp = 6)
...
ReferenceSet<-BRCARPPADATAFINAL
Workflow.Data<-WorkflowPathData(EvaluationExperimentSet,ReferenceSet)
Merged.options<-BuildEvaluationStructure(Workflow.Data,EvaluationTag=c("Allfeatures","Over1000","Over5000","Over10000"))
Model.quality.object<-WorkflowPathModelQuality(Merged.options)
Model.Quality<-ModelQualityPairs(Model.quality.object,method="pearson")
Posterior.dataframe<-EstimatePosteriorProbability(Model.quality.object,Model.Quality)
Evaluation.table<-WorkflowEvaluationTable(Posterior.dataframe)
